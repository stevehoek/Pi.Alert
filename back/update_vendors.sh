...
sudo curl -L $1 -# -O https://standards-oui.ieee.org/iab/iab.csv
sudo curl -L $1 -# -O https://standards-oui.ieee.org/iab/iab.txt

sudo curl -L $1 -# -O https://standards-oui.ieee.org/oui28/mam.csv
sudo curl -L $1 -# -O https://standards-oui.ieee.org/oui28/mam.txt

sudo curl -L $1 -# -O https://standards-oui.ieee.org/oui36/oui36.csv
sudo curl -L $1 -# -O https://standards-oui.ieee.org/oui36/oui36.txt

sudo curl -L $1 -# -O https://standards-oui.ieee.org/oui/oui.csv
sudo curl -L $1 -# -O https://standards-oui.ieee.org/oui/oui.txt
